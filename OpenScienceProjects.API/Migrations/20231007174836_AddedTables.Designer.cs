...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.Interest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.UserInterest", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.UserSkill", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.UserInterest", b =>
                {
                    b.HasOne("OpenScienceProjects.API.Entities.Interest", "Interest")
                        .WithMany()
            ...
            modelBuilder.Entity("OpenScienceProjects.API.Entities.UserSkill", b =>
                {
                    b.HasOne("OpenScienceProjects.API.Entities.Skill", "Skill")
                        .WithMany()
